                ...
                <Col xl={14} lg={18} md={20} sm={24}>
                    <div className="card">
                        ...
                        <p>
                            ...
                            applies to this project; with the specific additions regarding usage analytics (and a way to opt-out) stated <a href="https://cceh.uni-koeln.de/impressum/" target="_blank" rel="noopener noreferrer">here</a>
                            and the additions regarding the (entirely local) storage of application settings stated below:
                        </p>
