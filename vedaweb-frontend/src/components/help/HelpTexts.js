...
const helpTexts = {
    ...
    version_lubotskyzurich : {
        title: "Lubotsky (Zurich) in ISO-15919",
        content:
            <div>
                <p>
    ...
    metaLabels : {
        ...
        content:
            <div>
                ...
                <details>
                    <summary>Show list of pada labels</summary>
                    <table style={{width: 'auto'}}><tbody>
    ...
    metaStrata : {
        ...
        content:
            <div>
                ...
                <details>
                    <summary>Show list of stanza strata</summary>
                    <table style={{width: 'auto'}}><tbody>
    ...
    clearLocalStorage : {
        ...
        content:
            <div>
                <p>
                    If you agreed to it when visiting VedaWeb for the first time, it uses the local storage of
                    your browser to remember a few settings you made, such as search settings or the search term
                    you last entered into a search field. The next time you visit VedaWeb, these settings would still
                    be there for you to use. This is meant as a convenience feature. No personal data will be stored this way.
                </p>
                <p>
                    If you want to delete this locally stored data, you can easily do so by clicking the button at the
                    bottom of the page that says "Delete locally stored settings".
                </p>
                <h4>Why would I want to delete these settings?</h4>
                <p>
